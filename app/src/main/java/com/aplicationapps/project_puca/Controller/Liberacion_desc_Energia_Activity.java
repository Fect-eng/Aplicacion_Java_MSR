...
public class Liberacion_desc_Energia_Activity extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_liberacion_desc_energia);
        ...
        getSupportActionBar().setTitle("Liberacion Descarga Energia");
