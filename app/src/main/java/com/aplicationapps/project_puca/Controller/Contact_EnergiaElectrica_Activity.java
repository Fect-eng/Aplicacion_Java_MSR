...
public class Contact_EnergiaElectrica_Activity extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contact_energia_electrica);
        ...
        getSupportActionBar().setTitle("Contacto Energia Electrica");
