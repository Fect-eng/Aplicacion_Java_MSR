...
public class PerdidaControl_Minero_Auxiliar_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perdida_control_minero_auxiliar);
        ...
        getSupportActionBar().setTitle("Control Minero Auxiliar");
