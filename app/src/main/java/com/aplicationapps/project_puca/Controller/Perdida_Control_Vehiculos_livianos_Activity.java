...
public class Perdida_Control_Vehiculos_livianos_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_perdida_control_vehiculos_livianos);
        ...
        getSupportActionBar().setTitle("Vehiculos Livianos");
