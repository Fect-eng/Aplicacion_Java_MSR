...
public class Descarga_Electrica_Rayo_Activity extends AppCompatActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_descarga_electrica_rayo);
        ...
        getSupportActionBar().setTitle("Descarga Electrica por Rayo");
